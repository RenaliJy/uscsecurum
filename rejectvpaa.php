...
$query="SELECT b.bookingID, b.bookername, b.status, b.contactNumber, d.deptName , b.datevisit, b.noofPersons, b.purpose, b.comment FROM booking b
Join department d
ON d.departmentID=b.departmentTo
WHERE b.status = 'rejected' ORDER BY b.bookingID DESC";
...
<html> 
	<head>
		...
		<body>
			...
			<h3 style="font-family: Century; margin-bottom:20px; margin-top: 5px"> REJECTED BOOKINGS </h3> <br> <br>  
			<div class="container"> 
